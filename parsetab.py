...
_lr_signature = 'instruccionleftYOleftMENORMAYORMENOR_IGUALMAYOR_IGUALIGUALDADDIFERENTEleftMASMENOSleftMULTIPLICACIONDIVISIONMODULOA ACTUALIZAR AGREGAR AGRUPAR_POR ALGUNO ALGUNOS ALTERAR ASCENDENTE AUTOINCREMENTAL BOOLEANO CADENA CAMBIAR CARACTER CASO CLAVE_FORANEA CLAVE_PRIMARIA COLOCAR COLUMNA COMA COMENTARIO COMILLAS_SIMPLES COMO COMPLETO CON CONFIRMAR CONTAR CONVERTIR CREAR CUALQUIERA DECIMAL DERECHO DESCENDENTE DESDE DIFERENTE DISTINTO DIVISION DONDE ELIMINAR ENTERO ENTONCES ENTRE ES ESTABLECER_TRANSACCION ES_NULO EXISTE FECHA FIN FLOTANTE IDENTIFICADOR IDENTIFICADOR_INVALIDO IGUALDAD INICIAR_TRANSACCION INICIO INSERTAR_EN IZQUIERDO LIMITAR MAS MAXIMO MAYOR MAYOR_IGUAL MENOR MENOR_IGUAL MENOS MEZCLAR MIENTRAS MINIMO MODIFICAR MODULO MULTIPLICACION NO NORMAL NO_ES_NULO NO_NULO NULO O OBTENER ORDENAR_POR PARA PARENTESIS_DER PARENTESIS_IZQ PRIMEROS PROMEDIO PUNTO PUNTO_GUARDADO PYC RANGO REEMPLAZAR RENOMBRAR RESTRICCION REVERTIR SALTO_DE_LINEA SELECCIONAR SI SIMILAR_A SINO SOLTAR SUMA TABLA TENIENDO TEXTO TODO TODOS UNIR VALORES VALOR_BOOLEANO VALOR_CADENA VALOR_FLOTANTE VALOR_NUMERO Ycrear : CREAR TABLA IDENTIFICADOR PARENTESIS_IZQ lista_columnas_crear PARENTESIS_DERsoltar : SOLTAR TABLA IDENTIFICADORlista_columna_crear : IDENTIFICADOR tipo_dato restriccionesseleccion : SELECCIONAR lista_floro lista_columnas DESDE IDENTIFICADOR opt_condicionestransaccion : INICIAR_TRANSACCIONinsertar : INSERTAR_EN IDENTIFICADOR PARENTESIS_IZQ lista_columnas_creadas PARENTESIS_DER VALORES lista_filasactualizar : ACTUALIZAR IDENTIFICADOR COLOCAR lista_asignaciones opt_condicionesalterar : ALTERAR TABLA IDENTIFICADOR alteracionesunir : UNIR tipo_unir IDENTIFICADOR CON condicioneliminar : eliminar_todo\n| eliminar_donde\n| eliminar_hasta_todo\n| eliminar_hasta_dondelista_columnas_crear : lista_columnas_crear COMA lista_columna_crear\n| lista_columna_creartransaccion : CONFIRMARlista_columnas_creadas : IDENTIFICADOR\n| lista_columnas_creadas COMA IDENTIFICADORlista_asignaciones : IDENTIFICADOR IGUALDAD valor\n| lista_asignaciones COMA IDENTIFICADOR IGUALDAD valortipo_dato : ENTERO especificacion\n| CADENA especificacion\n| CARACTER especificacion\n| FECHA especificacion\n| BOOLEANO especificacion\n| DECIMAL especificacion\n| TEXTO especificacion\n| FLOTANTE especificaciontransaccion : REVERTIRtipo_unir : NORMAL\n| IZQUIERDO\n| DERECHO\n| COMPLETO\n| emptyalteraciones : alteracioneliminar_todo : ELIMINAR DESDE IDENTIFICADORlista_filas : fila \n| lista_filas COMA filalista_floro : lista_floro floro\n| floroalteraciones : alteracion COMA alteracioneseliminar_donde : ELIMINAR DESDE IDENTIFICADOR clausulacondicion : IDENTIFICADOR IGUALDAD IDENTIFICADOReliminar_hasta_todo : ELIMINAR PRIMEROS VALOR_NUMERO DESDE IDENTIFICADORalteracion : AGREGAR opt_column lista_columna_crearfila : PARENTESIS_IZQ lista_valores PARENTESIS_DERespecificacion : PARENTESIS_IZQ VALOR_NUMERO PARENTESIS_DER\n| emptyfloro : DISTINTO\n| PRIMEROS VALOR_NUMERO\n| emptyempty :eliminar_hasta_donde : ELIMINAR PRIMEROS VALOR_NUMERO DESDE IDENTIFICADOR clausulalista_valores : valor\n| lista_valores COMA valoropt_column : COLUMNA\n| emptyinstruccion : seleccion\n| insertar\n| alterar\n| actualizar\n| eliminar\n| soltar\n| crear\n| transaccion\n| unir\n| valorclausula : DONDE IDENTIFICADOR comparador valorrestricciones : restricciones restriccion\n| restriccion\n| emptycomparador : IGUALDAD\n| MAYOR\n| MENOR\n| MAYOR_IGUAL\n| MENOR_IGUAL\n| DIFERENTElista_columnas : IDENTIFICADOR\n| lista_columnas COMA IDENTIFICADOR\n| TODOalteracion : SOLTAR opt_column IDENTIFICADORalteracion : MODIFICAR opt_column lista_columna_crearvalor : VALOR_NUMERO\n| VALOR_CADENA\n| VALOR_BOOLEANO\n| VALOR_FLOTANTErestriccion : CLAVE_PRIMARIA\n| CLAVE_FORANEA\n| AUTOINCREMENTAL\n| NO_NULOalteracion : RENOMBRAR opt_column IDENTIFICADOR A IDENTIFICADORopt_condiciones : condiciones\n| emptyalteracion : CAMBIAR opt_column IDENTIFICADOR lista_columna_crearcondiciones : condiciones clausula\n| clausulacondicion_order : IDENTIFICADOR ASCENDENTE\n| IDENTIFICADOR DESCENDENTE\n| IDENTIFICADOR'
    
_lr_action_items = {'SELECCIONAR':([0,],[12,]),'INSERTAR_EN':([0,],[13,]),'ALTERAR':([0,],[14,]),'ACTUALIZAR':([0,],[15,]),'SOLTAR':([0,55,84,],[20,69,69,]),'CREAR':([0,],[21,]),'INICIAR_TRANSACCION':([0,],[22,]),'CONFIRMAR':([0,],[23,]),'REVERTIR':([0,],[24,]),'UNIR':([0,],[25,]),'VALOR_NUMERO':([0,34,48,92,129,130,131,132,133,134,135,137,142,151,171,],[26,53,61,26,26,-72,-73,-74,-75,-76,-77,26,26,169,26,]),'VALOR_CADENA':([0,92,129,130,
[-83,-84,-85,-86,78,78,78,78,-96,78,-19,-95,-68,-20,]),'PARENTESIS_DER':([26,27,28,29,64,65,99,100,107,117,118,119,120,121,122,123,124,125,143,144,145,146,147,148,149,150,152,153,154,155,156,157,158,159,160,163,164,168,169,173,174,],[-83,-84,-85,-86,-17,82,126,-15,-18,-52,-52,-52,-52,-52,-52,-52,-52,-52,-3,-70,-71,-87,-88,-89,-90,-21,-48,-22,-23,-24,-25,-26,-27,-28,-14,170,-54,-69,173,-47,-55,]),'DESDE':([30,49,50,52,61,81,],[47,62,-78,-80,79,-79,]),'PARENTESIS_IZQ':([36,58,106,118,119,120,121,122,123,124,125,165,],[54,75,137,151,151,151,151,151,151,151,151,137,]),'COLOCAR':([38,],[56,]),'AGREGAR':([55,84,],[68,68,]),'MODIFICAR':([55,84,],[70,70,]),'RENOMBRAR':([55,84,],[71,71,]),'CAMBIAR':([55,84,],[72,72,]),'CON':([59,],[76,]),'COLUMNA':([68,69,70,71,72,],[86,86,86,86,86,]),'IGUALDAD':([73,101,103,115,],[92,128,130,142,]),'VALORES':([82,],[106,]),'ENTERO':([98,],[118,]),'CADENA':([98,],[119,]),'CARACTER':([98,],[120,]),'FECHA':([98,],[121,]),'BOOLEANO':([98,],[122,]),'DECIMAL':([98,],[123,]),'TEXTO':([98,],[124,]),'FLOTANTE':([98,],[125,]),'MAYOR':([103,],[131,]),'MENOR':([103,],[132,]),'MAYOR_IGUAL':([103,],[133,]),'MENOR_IGUAL':([103,],[134,]),'DIFERENTE':([103,],[135,]),'A':([112,],[140,]),'CLAVE_PRIMARIA':([117,118,119,120,121,122,123,124,125,143,144,145,146,147,148,149,150,152,153,154,155,156,157,158,159,168,173,],[146,-52,-52,-52,-52,-52,-52,-52,-52,146,-70,-71,-87,-88,-89,-90,-21,-48,-22,-23,-24,-25,-26,-27,-28,-69,-47,]),'CLAVE_FORANEA':([117,118,119,120,121,122,123,124,125,143,144,145,146,147,148,149,150,152,153,154,155,156,157,158,159,168,173,],[147,-52,-52,-52,-52,-52,-52,-52,-52,147,-70,-71,-87,-88,-89,-90,-21,-48,-22,-23,-24,-25,-26,-27,-28,-69,-47,]),'AUTOINCREMENTAL':([117,118,119,120,121,122,123,124,125,143,144,145,146,147,148,149,150,152,153,154,155,156,157,158,159,168,173,],[148,-52,-52,-52,-52,-52,-52,-52,-52,148,-70,-71,-87,-88,-89,-90,-21,-48,-22,-23,-24,-25,-26,-27,-28,-69,-47,]),'NO_NULO':([117,118,119,120,121,122,123,124,125,143,144,145,146,147,148,149,150,152,153,154,155,156,157,158,159,168,173,],[149,-52,-52,-52,-52,-52,-52,-52,-52,149,-70,-71,-87,-88,-89,-90,-21,-48,-22,-23,-24,-25,-26,-27,-28,-69,-47,]),}
