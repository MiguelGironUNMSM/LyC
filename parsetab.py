...
_lr_goto_items = {'instruccion':([0,],[1,]),'seleccion':([0,],[2,]),'insertar':([0,],[3,]),'alterar':([0,],[4,]),'actualizar':([0,],[5,]),'eliminar':([0,],[6,]),'soltar':([0,],[7,]),'crear':([0,],[8,]),'transaccion':([0,],[9,]),'unir':([0,],[10,]),'valor':([0,92,130,138,143,174,],[11,115,163,165,168,178,]),'eliminar_todo':([0,],[16,]),'eliminar_donde':([0,],[17,]),'eliminar_hasta_todo':([0,],[18,]),'eliminar_hasta_donde':([0,],[19,]),'lista_floro':([12,],[31,]),'floro':([12,31,],[32,50,]),'empty':([12,25,31,66,67,68,69,70,72,80,118,119,120,121,122,123,124,125,126,],[34,45,34,87,87,87,87,87,96,96,146,153,153,153,153,153,153,153,153,]),'tipo_unir':([25,],[40,]),'lista_columnas':([31,],[48,]),'lista_columnas_creadas':([52,],[63,]),'alteraciones':([53,84,],[64,109,]),'alteracion':([53,84,],[65,65,]),'lista_asignaciones':([54,],[72,]),'condicional':([55,],[73,]),'clausula':([58,72,80,95,105,],[77,97,97,117,137,]),'opt_column':([66,67,68,69,70,],[85,88,89,90,91,]),'opt_condiciones':([72,80,],[93,106,]),'condiciones':([72,80,],[95,95,]),'lista_columnas_crear':([75,],[100,]),'lista_columna_crear':([75,85,89,114,128,],[101,110,112,142,161,]),'condicion':([76,],[103,]),'tipo_dato':([99,],[118,]),'comparador':([104,],[130,]),'lista_filas':([107,],[139,]),'fila':([107,166,],[140,175,]),'restricciones':([118,],[144,]),'restriccion':([118,144,],[145,169,]),'especificacion':([119,120,121,122,123,124,125,126,],[151,154,155,156,157,158,159,160,]),'lista_valores':([138,],[164,]),'referencia':([148,],[170,]),}
...
_lr_productions = [
  ...
  ('lista_columnas_crear -> lista_columnas_crear COMA lista_columna_crear','lista_columnas_crear',3,'p_lista_columnas_crear','Create.py',20),
  ('lista_columnas_crear -> lista_columna_crear','lista_columnas_crear',1,'p_lista_columnas_crear','Create.py',21),
  ...
  ('referencia -> REFERENCIA IDENTIFICADOR PARENTESIS_IZQ IDENTIFICADOR PARENTESIS_DER','referencia',5,'p_referencia','ReglasComunes.py',53),
  ('alteracion -> RENOMBRAR opt_column IDENTIFICADOR A IDENTIFICADOR','alteracion',5,'p_alteracion_rename','Alter.py',55),
  ('opt_condiciones -> condiciones','opt_condiciones',1,'p_opt_condiciones','ReglasComunes.py',60),
  ('opt_condiciones -> empty','opt_condiciones',1,'p_opt_condiciones','ReglasComunes.py',61),
  ('alteracion -> CAMBIAR opt_column IDENTIFICADOR lista_columna_crear','alteracion',4,'p_alteracion_change','Alter.py',62),
  ('condiciones -> condiciones clausula','condiciones',2,'p_condiciones','ReglasComunes.py',66),
  ('condiciones -> clausula','condiciones',1,'p_condiciones','ReglasComunes.py',67),
  ('condicion_order -> IDENTIFICADOR ASCENDENTE','condicion_order',2,'p_condicion_order','ReglasComunes.py',109),
  ('condicion_order -> IDENTIFICADOR DESCENDENTE','condicion_order',2,'p_condicion_order','ReglasComunes.py',110),
  ('condicion_order -> IDENTIFICADOR','condicion_order',1,'p_condicion_order','ReglasComunes.py',111),
]
